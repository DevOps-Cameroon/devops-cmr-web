...
export const showcaseEvents = [
  {
    id: 'devops-meetup-aug-2026',
    year: '2026',
    title: 'DevOps Meetup',
    tag: 'Meetup · Community',
    accent: '#3ddc84',
    dateISO: '2026-08-15T14:00:00',
    dateLabel: '15 August 2026',
    venue: 'bSpace Coworking, Douala',
    ...
    desc: 'A community meetup onCI/CD best practices and platform engineering.',
    summary: 'Lightning talks, demos, and networking for DevOps practitioners in Douala.',
    highlights: [
      'Lightning talks from community members',
      'Live CI/CD pipeline demo',
      'Networking with local DevOps engineers',
      'Food and drinks provided',
    ],
    speakers: speakerData.cloudSpeakers.slice(0, 3),
    organizers: organizerBase,
    topics: ['CI/CD', 'Platform Engineering', 'Community', 'Networking'],
  },
  {
