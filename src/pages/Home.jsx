...
//         </p>
//         <h3 className="font-mono text-xl font-bold uppercase tracking-tight text-ink sm:text-2xl">
//           {next.title}
//         </h3>
...
//             <dd className="text-ink">{taken}/{next.capacity} filled</dd>
//           </div>
//         </dl>
...
//           {[{ label: "Slack", href: "https://slack.com" }, { label: "WhatsApp", href: "https://whatsapp.com" }, { label: "Discord", href: "https://discord.com" }].map((c) => (
